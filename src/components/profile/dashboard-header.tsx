...
export function DashboardHeader() {
  ...
  // This needs to be defined inside the component to access `mounted` and `user` state.
  const CreditsButton = () => {
  ...
  return (
    <header className="sticky top-0 left-0 right-0 z-50 transition-all bg-white dark:bg-[#22252a] shadow-md">
