      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <Tabs defaultValue="sugar-daddy" className="max-w-3xl mx-auto">
          ...
          <TabsList className="grid w-full grid-cols-2 bg-transparent p-0 max-w-xl mx-auto">
            <TabsTrigger value="sugar-daddy" className="data-[state=active]:bg-primary/20 dark:data-[state=active]:bg-[#22252a] data-[state=active]:text-primary data-[state=active]:shadow-none rounded-md">
              {definitions['sugar-daddy'].title}
            </TabsTrigger>
            <TabsTrigger value="sugar-baby" className="data-[state=active]:bg-primary/20 dark:data-[state=active]:bg-[#22252a] data-[state=active]:text-primary data-[state=active]:shadow-none rounded-md">
