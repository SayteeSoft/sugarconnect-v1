       ...
       <Dialog>
        <div className="container mx-auto flex items-center justify-between flex-wrap gap-4">
          <p className="text-sm text-muted-foreground flex-1">
            To enhance your browsing experience and ensure our platform works effectively, we use cookies and other similar technologies to analyze site traffic and personalize content. By clicking &quot;Accept&quot;, you consent to our use of these technologies. You can learn more about how we use cookies and manage your preferences by reading our {' '}
