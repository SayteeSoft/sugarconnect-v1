      ...
      <main className="flex-grow">
        <section className="relative h-[85vh] md:h-[85vh] flex items-center justify-center text-white text-center overflow-hidden">
          ...
          <div className="relative z-20 px-4">
            <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-headline font-bold tracking-tighter mb-4">
              Sugar Connect
            </h1>
            <p className="max-w-2xl mx-auto text-lg sm:text-xl md:text-2xl lg:text-3xl font-light mb-6">
