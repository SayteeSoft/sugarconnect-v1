...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI assistant designed to summarize user profiles for a dating app, SugarConnect. Given the profile details and the current user's interests, create a concise and engaging summary highlighting the most relevant aspects.
